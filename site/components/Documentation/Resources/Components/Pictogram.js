      ...
      <DocumentationContent>
          ...
          <Grid key={ index } responsive={ false }>
            { chunk.map((name) => (
              <GridCell key={ name } width={ 25 }>
                <Grid gutters="tiny" none textCenter textLeft="small" verticalAlign="middle">
                  <GridCell>
                    <Pictogram name={ name } />
                  </GridCell>
        ...
        <DocumentationShowCase centered>
          <Grid gutters="tiny" responsive={ false } shrink verticalAlign="middle">
            <GridCell><Pictogram name="featured-content" size="2rem" /></GridCell>
            <GridCell><Pictogram name="featured-content" size="3rem" /></GridCell>
            <GridCell><Pictogram name="featured-content" size="4rem" /></GridCell>
            <GridCell><Pictogram name="featured-content" size="5rem" /></GridCell>
          </Grid>
        </DocumentationShowCase>
