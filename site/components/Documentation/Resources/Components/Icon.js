      ...
      <DocumentationContent>
        ...
        <DocumentationShowCase centered>
          <Grid gutters="tiny" none responsive={false} verticalAlign="middle">
            ...
            <GridCell>
              <Icon name="star" size="4rem" />
            </GridCell>
            <GridCell>
              <Icon name="star" size="5rem" />
            </GridCell>
          </Grid>
        </DocumentationShowCase>

        <DocumentationApi components={[iconProps]} />

        <DocumentationShowCase centered>
          <Grid gutters="tiny" responsive={false} verticalAlign="middle">
            <GridCell>
              <Animicon isIn name="tick" size="3rem" />
            </GridCell>
            <GridCell>
              <Animicon isIn name="cross" size="3rem" />
            </GridCell>
          </Grid>
        </DocumentationShowCase>
