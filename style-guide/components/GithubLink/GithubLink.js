...
import { Base, Grid, GridCell, Link } from 'bw-axiom';
...
export default class GithubLink extends Component {
  render() {
    ...
    return (
      <Base space="x8">
        <Link href="https://github.com/BrandwatchLtd/axiom" style="inherit" target="_blank">
          <Grid horizontalAlign="middle" responsive={ false } shrink>
            <GridCell>
              <svg
                  height="20"
