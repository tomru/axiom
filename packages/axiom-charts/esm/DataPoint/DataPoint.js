...
var DataPoint = function (_Component) {
  ...
  function DataPoint() {
    ...
    return _possibleConstructorReturn(this, (DataPoint.__proto__ || Object.getPrototypeOf(DataPoint)).apply(this, arguments));
  }
  ...
  _createClass(DataPoint, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          style = _props.style,
          r = _props.r,
          rest = _objectWithoutProperties(_props, ['color', 'style', 'r']);

      var classes = classnames('ax-data-point', 'ax-data-point--' + color, 'ax-data-point--' + style);
