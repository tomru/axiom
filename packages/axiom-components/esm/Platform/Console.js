  ...
  _createClass(Console, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          shade = _props.shade,
          width = _props.width,
          rest = _objectWithoutProperties(_props, ['children', 'position', 'shade', 'width']);

      var openConsolePosition = this.context.openConsolePosition;

      var style = { width: width };
      var classes = classnames('ax-platform__console', 'ax-platform__console--' + position, 'ax-platform__console--' + shade, {
