...
var Notifications = function (_Component) {
  ...
  _createClass(Notifications, [{
    ...
    value: function render() {
      ...
      var isRendered = Boolean(Array.isArray(children) ? children.length : children);
      ...
      return React.createElement(
        ...
        React.createElement(
          Base,
          _extends({}, rest, { className: 'ax-notifications' }),
          Children.map(children, function (child) {
            return React.createElement(
              'div',
              { className: 'ax-notifications__notification' },
              child
            );
          })
        )
