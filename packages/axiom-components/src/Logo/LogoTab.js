      ...
      <Logo {...rest} viewBoxHeight={viewBoxHeight} viewBoxWidth={viewBoxWidth}>
        ...
        >
          ...
          <g>
            ...
            <path
              className="cls-2"
              d="M70.725,109.4a.73.73,0,0,1-.912-.015.977.977,0,0,1-.383-.839v-4.183h1.388v-1.441H69.429v-1.488H67.992v1.486h-.836v1.442h.837v4.181a2.313,2.313,0,0,0,1.207,2.193,2.212,2.212,0,0,0,.969.222,2.135,2.135,0,0,0,1.363-.478l.048-.04-.8-1.082Z"
            />
            <polygon
              className="cls-2"
              points="56.534 108.318 54.992 102.919 53.665 102.919 52.123 108.318 50.581 102.919 49.215 102.919 51.459 110.775 52.787 110.775 54.329 105.376 55.871 110.775 57.198 110.775 59.442 102.919 58.076 102.919 56.534 108.318"
            />
            <path
              className="cls-2"
              d="M20.3,105.46a2.23,2.23,0,0,0,.27-.295,2.733,2.733,0,0,0,.529-1.7,2.614,2.614,0,0,0-.955-2.162,4.01,4.01,0,0,0-2.546-.715H14.674v10.189h3.458a3.541,3.541,0,0,0,2.446-.811,2.873,2.873,0,0,0,.931-2.242,2.649,2.649,0,0,0-.713-1.82A2.936,2.936,0,0,0,20.3,105.46Zm-.685,3.442a2.145,2.145,0,0,1-1.446.437H16.1v-3.055H18.3a2,2,0,0,1,1.34.441,1.26,1.26,0,0,1,.447,1.008A1.455,1.455,0,0,1,19.615,108.9Zm.051-5.465a1.222,1.222,0,0,1-.411,1.046,2.56,2.56,0,0,1-1.533.366H16.1v-2.83h1.568C19.666,102.045,19.666,103.021,19.666,103.437Z"
            />
            <path
              className="cls-2"
              d="M37.631,102.791c-1.861,0-2.972,1.2-2.972,3.2v4.778h1.429v-4.789a1.557,1.557,0,1,1,3.088,0v4.79H40.6V106C40.6,103.989,39.491,102.791,37.631,102.791Z"
            />
            <path
              className="cls-2"
              d="M82.527,102.791a2.629,2.629,0,0,0-1.742.585V100.1H79.356v10.674h1.429v-4.757a1.662,1.662,0,0,1,1.641-1.79,1.559,1.559,0,0,1,1.466,1.735v4.81h1.434V106.1C85.326,102.95,83,102.791,82.527,102.791Z"
            />
            <path
              className="cls-2"
              d="M25.756,102.791c-1.861,0-2.973,1.2-2.973,3.2v4.778h1.43v-4.789a1.544,1.544,0,0,1,1.544-1.758,1.868,1.868,0,0,1,.526.074l.372-1.4A3.842,3.842,0,0,0,25.756,102.791Z"
            />
            <path
              className="Anon-3"
              d="M21.739,44.234V60.8l19.289,9.133L60.754,49.1,47.82,25.446a6.823,6.823,0,0,0-1.213.548L25.132,38.369A6.769,6.769,0,0,0,21.739,44.234Z"
            />
            <polygon
              className="Anon-2"
              points="41.028 69.935 64.285 80.947 74.84 74.865 60.754 49.101 41.028 69.935"
            />
            <path
              className="Anon-5"
              d="M72.31,36.9l-18.917-10.9a6.8,6.8,0,0,0-5.573-.548L60.754,49.1Z"
            />
            <path
              className="Anon-4"
              d="M74.84,74.865l.028-.017a6.767,6.767,0,0,0,3.393-5.865V44.234a6.769,6.769,0,0,0-3.393-5.865L72.31,36.9,60.754,49.1Z"
            />
            <path
              className="Anon-12102"
              d="M21.739,60.8v8.181a6.767,6.767,0,0,0,3.393,5.865l7.275,4.192,8.621-9.105Z"
            />
            <path
              className="cls-3"
              d="M32.407,79.04l14.2,8.183a6.8,6.8,0,0,0,6.786,0l10.892-6.276L41.028,69.935Z"
            />
          </g>
        </svg>
      </Logo>
