...
export default class Grid extends Component {
  static propTypes = {
    ...
    horizontalGutters: PropTypes.oneOf([
      false,
      "tiny",
      "small",
      "medium",
    ...
    verticalGutters: PropTypes.oneOf([
      false,
      "tiny",
      "small",
      "medium",
  ...
  render() {
    ...
    const classes = classnames(
      "ax-grid",
      {
        ...
        [`ax-grid--gutters-horizontal--${horizontalGutters}`]:
          typeof horizontalGutters === "string",
        [`ax-grid--gutters-vertical--${verticalGutters}`]:
          typeof verticalGutters === "string",
