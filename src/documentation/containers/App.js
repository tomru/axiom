...
import * as navigationActions from 'documentation/actions/navigation';
import * as searchActions from 'documentation/actions/search';
import DocSearch from 'documentation/components/DocSearch';
import {
  Layout,
  LayoutHeader,
  LayoutSidebar,
