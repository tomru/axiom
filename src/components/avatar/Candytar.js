...
export default class Candytar extends Component {
  ...
  render() {
    ...
    const classes = classnames('ax-candytar-placeholder', `ax-candytar-placeholder--${color}`);
    const bodyColorMatrix = `
      1 0 0 0    -0.27
      0 1 0 0    -0.27
      0 0 1 0    -0.27
      0 0 0 0.55  0
